...
The primitives of CAT are variables (i.e. $x, y, z$) and numbers 
(i.e. $1, -10, 3.141592$). These primitives can be combined with mathematical
operations such as +, -, *, /, \^{}, $\sin$, $\cos$, $\log$, sqrt, Differentiate,
and Integrate in order to form expressions\dots
